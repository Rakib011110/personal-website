...
const Experience = () => {
  ...
  return (
    ...
    >
      <div class=" items-center  mt-64 justify-center ">
                    ...
                    <div>
                      <div class="">
                        <div class="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
                          ...
                          <div class="absolute inset-0  from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
